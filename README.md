...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [FluxRelay](https://github.com/FluxRelay) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for FluxRelay.
...
```bash
git clone https://github.com/FluxRelay/core
cd core
go mod download
```
